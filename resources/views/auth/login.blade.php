            ...
            <div class="p-6">
                <h1 class="text-2xl font-bold text-center text-gray-900 p-4 pb-10">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Masukkan email anda">
                        @error('email')
                    ...
                    <div class="pb-4">
                        <p class="text-sm font-light text-gray-500">
                            Belum memiliki akun? <a href="{{ route('register') }}" class="font-medium text-blue-600 hover:underline">Daftar sekarang</a>
                        </p>
                    </div>
                </form>
            </div>
