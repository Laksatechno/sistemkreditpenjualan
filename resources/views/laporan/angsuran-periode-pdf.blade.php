...
<head>
    ...
    <title>Laporan Angsuran Per Pelanggan {{ \Carbon\Carbon::parse($startDate)->translatedFormat('d F Y') }} s.d. {{ \Carbon\Carbon::parse($endDate)->translatedFormat('d F Y') }}</title>
