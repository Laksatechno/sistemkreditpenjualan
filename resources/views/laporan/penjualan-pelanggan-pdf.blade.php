...
<head>
    ...
    <title>Laporan Angsuran Per Pelanggan {{ $penjualanKredit->first()->pelanggan->nama_pelanggan }}</title>
        ...
        <div class="mb-8">
            <table>
                <tr style="vertical-align: top !important">
                    ...
                    <td style="border: 0px !important;">{{ $penjualanKredit->first()->pelanggan->nama_pelanggan }}</td>
                </tr>
                <tr style="vertical-align: top !important">
                    <td style="border: 0px !important;">Telepon</td>
                    <td style="border: 0px !important;">:</td>
                    <td style="border: 0px !important;">{{ $penjualanKredit->first()->pelanggan->telepon }}</td>
                </tr>
                <tr style="vertical-align: top !important">
                    <td style="border: 0px !important;">Alamat</td>
                    <td style="border: 0px !important;">:</td>
                    <td style="border: 0px !important;">{{ $penjualanKredit->first()->pelanggan->alamat }}</td>
                </tr>
            </table>
        </div>
