...
<div>
    <span class="text-xl font-medium text-gray-600">Daftar Pelanggan</span>
</div>

{{-- Interaksi Pengguna --}}
<div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 mt-8">
    <div class="flex items-center">
        <a href="{{ route('pelanggan.create') }}" type="button" class="bg-blue-700 px-5 py-2.5  rounded-md text-white text-sm font-medium hover:bg-blue-800">
            Tambah Pelanggan
        </a>
    </div>
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <div class="flex items-center justify-start px-4 py-2 hover:bg-gray-100">
                                <input id="a-z" type="radio" value="az" name="filter-pelanggan" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300">
                                <label for="a-z" class="w-full ms-3 text-sm font-medium text-gray-900 rounded dark:text-gray-300">A-Z</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center justify-start px-4 py-2 hover:bg-gray-100">
                                <input id="z-a" type="radio" value="za" name="filter-pelanggan" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300">
        ...
        <div class="ml-4">
            <form action="{{ 'pelanggan' }}" method="GET">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="table-search" name="search" value="{{ request('search') }}" class="block py-2.5 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 focus:ring-gray-500 focus:border-gray-500" placeholder="Cari pelanggan">
                </div>
            </form>
        </div>
    </div>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                @php
                    $class = $item->status_identitas == 'tidak disertakan' ? 'bg-amber-100 px-2 py-1 rounded text-amber-600' : 'bg-green-100 px-2 py-1 rounded text-green-700';
                @endphp

                <td class="px-4 py-4 uppercase">
                    <span>
                        @if ($item->file_identitas)
                        <a href="{{ route('pelanggan.download', $item->id_pelanggan) }}" class="flex items-center gap-2">
                            <div class="{{ $class }}">
                ...
                <td class="px-4 py-4">
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <a href="#" data-modal-target="delete-modal-{{ $item->id_pelanggan }}" data-modal-toggle="delete-modal-{{ $item->id_pelanggan }}">
                        ...
                        {{-- Modal Delete Data --}}
                        <div id="delete-modal-{{ $item->id_pelanggan }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 py-8">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <p class="text-xl font-medium leading-relaxed text-center text-gray-500 dark:text-gray-400">
                                            Hapus <span class="text-gray-900"> {{ $item->nama_pelanggan }} </span>?
                                        </p>
                                        <p class="text-sm leading-relaxed text-center text-gray-500 dark:text-gray-400">
                                            Dengan menekan tombol <b>Hapus</b>, maka pelanggan akan terhapus secara permanen.
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-center p-4 md:p-5 rounded-b dark:border-gray-600">
                                        ...
                                        <a href="{{ route('pelanggan') }}" data-modal-hide="delete-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-700">
                                            Batal
                                        </a>
                                    </div>
                                </div>
